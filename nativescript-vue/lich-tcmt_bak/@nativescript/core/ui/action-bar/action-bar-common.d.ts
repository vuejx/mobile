...
export declare class ActionBarBase extends View implements ActionBarDefinition {
    ...
    get androidContentInset(): string | Length;
    set androidContentInset(value: string | Length);
    get androidContentInsetLeft(): Length;
    set androidContentInsetLeft(value: Length);
    get androidContentInsetRight(): Length;
    set androidContentInsetRight(value: Length);
    get ios(): any;
...
export declare const androidContentInsetLeftProperty: CssProperty<Style, Length>;
export declare const androidContentInsetRightProperty: CssProperty<Style, Length>;
