...
exports.getAngularCompilerPlugin = void 0;
const path_1 = require("path");
const webpack_1 = require("@ngtools/webpack");
function getAngularCompilerPlugin(platform) {
    class NativeScriptAngularCompilerPlugin extends webpack_1.AngularCompilerPlugin {
        ...
        getCompiledFile(file) {
            try {
                if (platform) {
                    ...
                    const platformFile = path_1.join(parsed.dir, `${parsed.name}.${platform}${parsed.ext}`);
...
exports.getAngularCompilerPlugin = getAngularCompilerPlugin;
